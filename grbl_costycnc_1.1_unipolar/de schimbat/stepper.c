 ...
 if (costyx==8) PORTD=0B100100;
  ...
  if (st.counter_y > st.exec_block->step_event_count) {
    ...
    if (st.exec_block->direction_bits & (1<<Y_DIRECTION_BIT)) { sys_position[Y_AXIS]--;
      ...
      if (costyy==1)   PORTC=0B10000000;
      if (costyy==2)   PORTC=0B11000000;
      if (costyy==3)   PORTC=0B01000000;
      if (costyy==4)   PORTC=0B01100000;
      if (costyy==5)  PORTC=0B00100000;
      if (costyy==6)  PORTC=0B00110000;
      if (costyy==7)  PORTC=0B00010000;
      if (costyy==8) PORTC=0B10010000;
	}
